...
public class Launch5 {
	public static void main(String[] args) {
		...
		//Specific catch
			...
			System.out.println("Arithmetic Exception occured and handled or "
					+ "Input Mismatch Exception occured and handled");
		}
		catch (NegativeArraySizeException | ArrayIndexOutOfBoundsException ai) {
			System.out.println("Negative Array Size Exception occured and handled or "
					+ "Array Index Out Of Bounds Exception occured and handled");
		}
		//Generic catch 
		catch (Exception e) {
